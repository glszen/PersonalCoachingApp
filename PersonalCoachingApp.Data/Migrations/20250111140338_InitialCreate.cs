    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageFeatureEntities", x => new { x.PackageId, x.FeatureId });
                    table.ForeignKey(
                        name: "FK_PackageFeatureEntities_Features_FeatureId",
                        column: x => x.FeatureId,
                        principalTable: "Features",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PackageFeatureEntities_Packages_PackageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackageFeatureEntities_FeatureId",
                table: "PackageFeatureEntities",
                column: "FeatureId");
        }
